      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="w-5 h-5 bg-slate-600 rounded-full animate-pulse"></div>
              ))}
            </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-4">
            ...
            {currentRating && (
              <Badge variant="outline" className="border-[#4fd1c5] text-[#4fd1c5] bg-[#4fd1c5]/10 text-xs">
            ...
            {isReviewing ? (
              <div className="space-y-3">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-[#4fd1c5]">Your Review</span>
                </div>
                <Textarea
                  value={reviewContent}
                ...
                {currentReview ? (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-slate-400">
                      Updated: {new Date(currentReview.updatedAt).toLocaleDateString()}
                    </p>
                  </div>
                ) : (
